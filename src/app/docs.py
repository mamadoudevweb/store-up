...
def register_openapi(app: Flask) -> None:
    ...
    try:
        from src.domains.stock.routes.v1 import openapi as stock_openapi
        stock_openapi.register()
    except ImportError:
        pass
        
    try:
        from src.domains.billing.routes.v1.openapi import billing_openapi
        billing_openapi.register()
    except ImportError:
        pass
