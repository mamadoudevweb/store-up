...
def upgrade():
    ...
    """
    Create the initial database schema for accounts, authentication, authorization, catalog, attributes, products, and inventory.
    """
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    """Remove the schema objects created by this migration."""
    with op.batch_alter_table('product_variant_attributes', schema=None) as batch_op:
